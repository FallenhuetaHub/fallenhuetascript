...
do
	...
	do
		...
		function Sections:Toggle(Properties)
			...
			--
			local NewToggle = Instance.new('Frame', Toggle.Section.Elements.SectionContent)
			...
			NewToggle.Size = UDim2.new(0, 20, 0, 20)
NewToggle.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
NewToggle.BorderSizePixel = 1
NewToggle.BorderColor3 = Color3.fromRGB(150, 150, 150)
